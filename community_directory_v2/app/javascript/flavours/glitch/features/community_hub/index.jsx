...
const messages = defineMessages({
  ...
  subtitle: {
    id: "community_hub.subtitle",
    defaultMessage: "Explore everything our community has to offer",
  },
  empty: {
    id: "community_hub.empty",
    defaultMessage: "No community directories have been set up yet. Check back soon!",
  },
  entries: {
    id: "community_hub.entries",
      ...
      <div className="scrollable">
        <div className="community-hub">
          <div className="community-hub__intro">
            ...
            <p className="community-hub__subtitle">{intl.formatMessage(messages.subtitle)}</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="community-hub__grid">
              {categories.map((cat) => (
                <CategoryCard key={cat.name} category={cat} intl={intl} />
              ))}
            </div>
          ) : (
  ...
  return (
    <Link to={category.route} className="community-hub__card">
      ...
      <div className="community-hub__card-body">
        <h3 className="community-hub__card-name">{category.display_name}</h3>

        {category.description && <p className="community-hub__card-desc">{category.description}</p>}
