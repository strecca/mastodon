...
const initialPath: string =
  document.querySelector("head meta[name=initialPath]")?.getAttribute("content") ?? "";
...
function getMeta<K extends keyof InitialStateMeta>(prop: K): InitialStateMeta[K] | undefined {
