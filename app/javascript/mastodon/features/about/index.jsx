        ...
        <div className="scrollable about" id={getColumnSkipLinkId(1)}>
          ...
          <div className="about__meta">
            ...
            <div className="about__meta__column">
              ...
              {isLoading ? (
                ...
                <a className="about__mail" href={`mailto:${server.item?.contact?.email}`}>
                  {server.item?.contact?.email}
                </a>
              )}
            </div>
          </div>
          ...
          <div className="about__footer">
            <p>
              <FormattedMessage
                id="about.disclaimer"
                defaultMessage="Mastodon is free, open-source software, and a trademark of Mastodon GmbH."
              />
            </p>
          </div>
        </div>
