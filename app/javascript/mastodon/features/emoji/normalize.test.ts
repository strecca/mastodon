...
const svgFileNamesWithoutBorder = svgFileNames.filter((fileName) => !fileName.endsWith("_border"));
...
describe("extractTokens", () => {
  ...
  test("check token word breaking with Intl.Segmenter", () => {
    ...
    expect(extractTokens("thumbs_up smiling-face camelCase", segmenter)).toEqual([
      "thumbs",
      "up",
      "smiling",
      "face",
