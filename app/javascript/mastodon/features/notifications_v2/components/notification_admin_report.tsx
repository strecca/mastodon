...
export const NotificationAdminReport: React.FC<{
  ...
  const intl = useIntl();
  const targetAccount = useAppSelector((state) => state.accounts.get(report.targetAccountId));
    ...
    >
      ...
      <div className="notification-group__main">
        ...
        {report.comment.length > 0 && (
          <div className="notification-group__embedded-status__content">“{report.comment}”</div>
        )}
      </div>
    </a>
  );
