...
const hidePeek = <T,>(list: T[]) => {
  if (list.length > INITIAL_PAGE_LIMIT && list.length % INITIAL_PAGE_LIMIT === 1) {
...
export const SearchResults: React.FC<{ multiColumn: boolean }> = ({ multiColumn }) => {
          ...
          0 ? (
            <>
                ...
                <SearchSection
                  ...
                  title={
                    <>
                      ...
                      <FormattedMessage id="search_results.accounts" defaultMessage="Profiles" />
                    </>
                  }
              ...
              {results.collections.length > 0 && (
                ...
                >
                  {results.collections.slice(0, INITIAL_DISPLAY).map((collection, index, array) => (
                    <CollectionListItem
                      key={collection.id}
        ...
        <ScrollableList
          ...
          emptyMessage={
            trimmedValue.length > 0 ? (
              <FormattedMessage id="search_results.no_results" defaultMessage="No results." />
            ) : (
              <FormattedMessage
