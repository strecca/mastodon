...
export const MostUsedApp: React.FC<{
  ...
  if (!app) {
    return <div className="annual-report__bento__box annual-report__summary__most-used-app" />;
  }

  return (
    <div className="annual-report__bento__box annual-report__summary__most-used-app">
      <div className="annual-report__summary__most-used-app__icon">{app.name}</div>
