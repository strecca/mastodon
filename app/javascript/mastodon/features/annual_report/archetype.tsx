...
import type { AnnualReport, Archetype as ArchetypeData } from "@/mastodon/models/annual_report";
...
export const Archetype: React.FC<{
  ...
  const [isRevealed, setIsRevealed] = useState(
    () => !isSelfView || (me ? (wrapstodonSettings.get(me)?.archetypeRevealed ?? false) : true),
  );
  ...
  const descriptions = isSelfView ? archetypeSelfDescriptions : archetypePublicDescriptions;
  ...
  return (
    ...
    >
      <div className={styles.archetypeArtboard}>
        {account && <Avatar account={account} size={50} className={styles.archetypeAvatar} />}
        ...
        <img src={space_elements} alt="" className={styles.archetypePlanetRing} />
      </div>
