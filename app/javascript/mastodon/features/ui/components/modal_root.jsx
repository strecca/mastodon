...
export const MODAL_COMPONENTS = {
  ...
  COLLECTION_ADDER: () =>
    import("@/mastodon/features/collection_adder").then((module) => ({
      default: module.CollectionAdder,
    })),
  SHARE_COLLECTION: () =>
    import("@/mastodon/features/collections/components/share_modal").then((module) => ({
      default: module.CollectionShareModal,
    })),
  REVOKE_COLLECTION_INCLUSION: () =>
    import("@/mastodon/features/collections/detail/revoke_collection_inclusion_modal").then(
  ...
  ACCOUNT_NOTE: () =>
    import("@/mastodon/features/account_timeline/modals/note_modal").then((module) => ({
      default: module.AccountNoteModal,
    })),
  ACCOUNT_FIELD_OVERFLOW: () =>
    import("@/mastodon/features/account_timeline/modals/field_modal").then((module) => ({
      default: module.AccountFieldModal,
    })),
  ACCOUNT_JOIN_DATE: () =>
    import("@/mastodon/features/account_timeline/modals/join_modal").then((module) => ({
  ...
  ACCOUNT_HIDE_FEATURED_TAB: () =>
    import("@/mastodon/features/ui/components/confirmation_modals/hide_featured_tab").then(
...
function accountEditModal(type) {
  return () =>
    import("@/mastodon/features/account_edit/modals").then((module) => ({ default: module[type] }));
}
