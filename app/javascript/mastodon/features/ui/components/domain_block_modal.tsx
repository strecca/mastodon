...
export const DomainBlockModal: React.FC<{
  ...
  const [preview, setPreview] = useState<DomainBlockPreviewResponse | "error" | null>(null);
        ...
        <div className="safety-action-modal__header">
          ...
          <div>
            <NavigationFocusTarget as="h1">
              <FormattedMessage id="domain_block_modal.title" defaultMessage="Block domain?" />
                  ...
                  <strong>
                    <FormattedMessage
                      ...
                      values={{
                        ...
                        followersCountDisplay: <ShortNumber value={preview.followers_count} />,
                        followingCount: preview.following_count,
                        followingCountDisplay: <ShortNumber value={preview.following_count} />,
                      }}
                    />
                  </strong>
                </div>
