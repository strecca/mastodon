...
const messages = defineMessages({
  ...
  similarToRecentlyFollowedHint: {
    ...
    defaultMessage: "This profile is similar to the profiles you have most recently followed.",
  },
  featuredHint: {
  ...
  mostInteractionsHint: {
    ...
    defaultMessage: "This profile has been recently getting a lot of attention on {domain}.",
  },
});
...
const Source: React.FC<{ id: ApiSuggestionSourceJSON }> = ({ id }) => {
  ...
  switch (id) {
    ...
    case "featured":
      ...
      label = (
        <FormattedMessage id="follow_suggestions.curated_suggestion" defaultMessage="Staff pick" />
      );
      break;
    case "most_followed":
...
export const InlineFollowSuggestions: React.FC<{ hidden?: boolean }> = ({ hidden }) => {
  const intl = useIntl();
  ...
  const { bodyRef, handleScroll, canScrollLeft, canScrollRight, handleLeftNav, handleRightNav } =
