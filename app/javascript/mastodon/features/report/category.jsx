...
const messages = defineMessages({
  ...
  legal_description: {
    ...
    defaultMessage: "You believe it violates the law of your or the server's country",
  },
  ...
  status: {
    ...
    defaultMessage: "Tell us what's going on with this post",
  },
  account: {
    id: "report.category.title_account",
    defaultMessage: "Tell us what's going on with this profile",
  },
  collection: {
    id: "report.category.title_collection",
    defaultMessage: "Tell us what's going on with this collection",
  },
});
    ...
    return (
      <>
        ...
        <p className="report-dialog-modal__lead">
          <FormattedMessage id="report.category.subtitle" defaultMessage="Choose the best match" />
        </p>
