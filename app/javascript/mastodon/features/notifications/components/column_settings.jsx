...
class ColumnSettings extends PureComponent {
  ...
  render() {
    ...
    const showStr = (
      <FormattedMessage id="notifications.column_settings.show" defaultMessage="Show in column" />
    );
    const soundStr = (
      <FormattedMessage id="notifications.column_settings.sound" defaultMessage="Play sound" />
    );
    const groupStr = (
    ...
    return (
      <div className="column-settings">
        ...
        <section role="group" aria-labelledby="notifications-follow-request">
          <h3 id="notifications-follow-request">
            <FormattedMessage
        ...
        <section role="group" aria-labelledby="notifications-reblog">
          <h3 id="notifications-reblog">
            <FormattedMessage id="notifications.column_settings.reblog" defaultMessage="Boosts:" />
          </h3>
        ...
        <section role="group" aria-labelledby="notifications-quote">
          <h3 id="notifications-quote">
            <FormattedMessage id="notifications.column_settings.quote" defaultMessage="Quotes:" />
          </h3>
        ...
        <section role="group" aria-labelledby="notifications-update">
          <h3 id="notifications-update">
            <FormattedMessage id="notifications.column_settings.update" defaultMessage="Edits:" />
          </h3>
        ...
        <ColumnSettingsGroup
          ...
          label={
            <FormattedMessage
              id="notifications.column_settings.collections"
              defaultMessage="Collections:"
            />
          }
        />

        {(this.props.identity.permissions & PERMISSION_MANAGE_USERS) ===
        ...
        {(this.props.identity.permissions & PERMISSION_MANAGE_REPORTS) ===
