import { apiRequestPost, apiRequestPut, apiRequestGet, apiRequestDelete } from "mastodon/api";
...
export const apiUpdateCollection = ({ id, ...collection }: ApiUpdateCollectionPayload) =>
...
export const apiGetCollection = (collectionId: string) =>
  apiRequestGet<ApiCollectionWithAccountsJSON>(`v1/collections/${collectionId}`);
...
export const apiAddCollectionItem = (collectionId: string, accountId: string) =>
  apiRequestPost<WrappedCollectionAccountItem>(`v1/collections/${collectionId}/items`, {
    account_id: accountId,
  });

export const apiRemoveCollectionItem = (collectionId: string, itemId: string) =>
  apiRequestDelete<WrappedCollectionAccountItem>(`v1/collections/${collectionId}/items/${itemId}`);

export const apiRevokeCollectionInclusion = (collectionId: string, itemId: string) =>
