...
export const Default = {
  render: function Render() {
    const [matchedHotkey, setMatchedHotkey] = useState<keyof HandlerMap | null>(null);
    ...
    return (
      <Hotkeys handlers={handlers}>
        ...
        >
          ...
          <p>
            Try typing a sequence, like <kbd>g</kbd> shortly followed by <kbd>h</kbd>, <kbd>n</kbd>,
            or
            <kbd>f</kbd>
          </p>
          <p>Note that this playground doesn&apos;t support all hotkeys we use in the app.</p>
          <p>
          ...
          <p>When an input element is focused, hotkeys should not interfere with regular typing:</p>
          <input type="text" />
        </div>
      </Hotkeys>
    );
