...
export const CalloutInline: FC<Partial<FieldStatus> & React.ComponentPropsWithoutRef<"div">> = ({
  variant = "error",
  message,
  className,
  children,
  ...
  return (
    <div {...props} className={classNames(className, classes.wrapper)} data-variant={variant}>
