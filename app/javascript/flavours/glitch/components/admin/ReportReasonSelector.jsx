  ...
  render() {
    ...
    return (
      <div
        tabIndex={0}
        role="button"
        className={classNames("report-reason-selector__category", { selected, disabled })}
      ...
      >
        ...
        {selected && children && (
          <div className="report-reason-selector__category__rules">{children}</div>
        )}
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div
        tabIndex={0}
        role="button"
        className={classNames("report-reason-selector__rule", { selected, disabled })}
        onClick={this.handleClick}
      >
        <span
          className={classNames("poll__input", { checkbox: true, active: selected, disabled })}
        />
