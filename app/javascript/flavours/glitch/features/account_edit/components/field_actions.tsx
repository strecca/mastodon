...
export const AccountFieldActions: FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <>
      <EditButton label={intl.formatMessage(messages.edit)} icon onClick={handleEdit} />
      <DeleteIconButton label={intl.formatMessage(messages.delete)} onClick={handleDelete} />
    </>
  );
};
