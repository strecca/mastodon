...
import { SelectField, TextInputField, Toggle } from "flavours/glitch/components/form_fields";
...
const NewList: React.FC<{ list?: List | null }> = ({ list }) => {
  ...
  const [repliesPolicy, setRepliesPolicy] = useState<RepliesPolicyType>(initialRepliesPolicy);
    ...
    <form className="simple_form app-form" onSubmit={handleSubmit}>
      <div className="fields-group">
        <TextInputField
          required
          maxLength={30}
          label={<FormattedMessage id="lists.list_name" defaultMessage="List name" />}
          value={title}
      ...
      <div className="fields-group">
        ...
        >
          <FormattedMessage id="lists.replies_policy.none" defaultMessage="No one">
            {(msg) => <option value="none">{msg}</option>}
          </FormattedMessage>
          <FormattedMessage id="lists.replies_policy.list" defaultMessage="Members of the list">
            {(msg) => <option value="list">{msg}</option>}
          </FormattedMessage>
          <FormattedMessage id="lists.replies_policy.followed" defaultMessage="Any followed user">
      ...
      <div className="fields-group">
        ...
        <label className="app-form__toggle">
          <div className="app-form__toggle__label">
            <strong>
              <FormattedMessage id="lists.exclusive" defaultMessage="Hide members in Home" />
            </strong>
            <span className="hint">
              <FormattedMessage
...
const NewListWrapper: React.FC<{
  ...
  return (
    ...
    >
      ...
      <Helmet>
        <title>{intl.formatMessage(id ? messages.edit : messages.create)}</title>
