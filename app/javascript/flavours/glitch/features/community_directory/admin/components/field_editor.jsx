    ...
    <div className={`cd-field-editor${isExisting ? " cd-field-editor--existing" : ""}`}>
      <div className="cd-field-editor__header">
        ...
        <button
          ...
          className="cd-field-editor__remove"
          title="Remove field"
        >
          ✕
        </button>
      ...
      <div className="cd-field-editor__body">
        ...
        <div className="cd-field-editor__row">
          ...
          <div className="cd-field-editor__col">
            <label>
              DB column{isExisting && <span className="cd-field-editor__locked"> (locked)</span>}
            </label>
            <input
              type="text"
              value={field.db_name}
        ...
        <div className="cd-field-editor__row">
          <div className="cd-field-editor__col">
            <label>
              Type{isExisting && <span className="cd-field-editor__locked"> (locked)</span>}
            </label>
            <select
              value={field.widget}
              onChange={(e) => update("widget", e.target.value)}
        ...
        {showOptions && (
          <div className="cd-field-editor__options">
              ...
              {(field.options || []).map((opt, i) => (
                <span key={i} className="cd-field-editor__option-tag">
                  ...
                  <button
                    ...
                    className="cd-field-editor__option-remove"
                  >
                    ✕
                  </button>
                </span>
            ...
            <div className="cd-field-editor__option-add">
              ...
              />
              <button type="button" onClick={handleAddOption} className="button button-secondary">
                Add
              </button>
            </div>
          </div>
