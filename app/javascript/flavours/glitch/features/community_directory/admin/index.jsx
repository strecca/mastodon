...
const messages = defineMessages({
  ...
  catNameHint: {
    id: "community_directory.admin.cat_name_hint",
    defaultMessage: "Lowercase, no spaces. Becomes the URL and table name.",
  },
  catNameLocked: {
    id: "community_directory.admin.cat_name_locked",
    defaultMessage: "Category key cannot be changed after creation.",
  },
  ...
  generate: {
    id: "community_directory.admin.generate",
    defaultMessage: "Generate community feature",
  },
  ...
  previewSection: {
    id: "community_directory.admin.preview_section",
    defaultMessage: "Form Preview",
  },
  back: { id: "community_directory.admin.back", defaultMessage: "Back to directory admin" },
  existingSection: {
    id: "community_directory.admin.existing",
    defaultMessage: "Existing Categories",
  },
  manageEntries: {
    id: "community_directory.admin.manage_entries",
    defaultMessage: "Manage Entries →",
  },
  noExisting: {
    id: "community_directory.admin.no_existing",
    defaultMessage: "No categories yet. Build your first one below.",
  },
  createNew: {
    id: "community_directory.admin.create_new",
    defaultMessage: "+ Create New Category",
  },
  editingBadge: { id: "community_directory.admin.editing_badge", defaultMessage: "editing" },
  templateSection: {
    id: "community_directory.admin.template_section",
    defaultMessage: "Start from a Template",
  },
  templateLoad: { id: "community_directory.admin.template_load", defaultMessage: "Load Template" },
  templateSave: {
    id: "community_directory.admin.template_save",
  ...
  templateNameHint: {
    id: "community_directory.admin.template_name_hint",
    defaultMessage: "Template name…",
  },
  templateChoose: {
    id: "community_directory.admin.template_choose",
...
const CommunityDirectoryFormBuilder = ({ multiColumn }) => {
  ...
  const categoriesLoading = useAppSelector(
    (state) => state.get("community_directory")?.get("categoriesLoading") || false,
  );
  ...
  const handleGenerate = useCallback(async () => {
    ...
    if (validFields.length === 0) {
      setError("At least one field with a name and label is required.");
      return;
    }
    ...
    try {
      const config = {
        ...
        display_name:
          displayName.trim() ||
          `Community ${catName.trim().replace(/\b\w/g, (c) => c.toUpperCase())}`,
          ...
          <section className="cd-builder__section cd-builder__section--existing">
                  ...
                  return (
                    <div key={name || i} className="cd-builder__existing-row">
                      ...
                      >
                        ...
                        <span className="cd-builder__existing-count">
                          {count} {count === 1 ? "entry" : "entries"}
                        </span>
                        {isActive && (
                          <span className="cd-builder__existing-badge">
                            {intl.formatMessage(messages.editingBadge)}
                          </span>
                        )}
                      </button>
                      <Link
                        to={`/community_directory/entries/${name}`}
                        className="cd-builder__existing-manage-link"
                      >
            ...
            {editingCategory && (
              <button
                ...
                className="button button-secondary cd-builder__new-btn"
              >
          ...
          {!editingCategory && (
            <section className="cd-builder__section cd-builder__section--templates">
              ...
              <p className="cd-builder__hint">
                Load a pre-built field set to skip repetitive setup. Checkbox options are left blank
          ...
          <section className="cd-builder__section">
            ...
            <div className="cd-builder__field">
              ...
              <textarea
                ...
                className="cd-builder__textarea"
                rows={2}
              />
            </div>
          </section>
