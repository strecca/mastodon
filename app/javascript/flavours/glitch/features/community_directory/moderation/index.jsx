...
const messages = defineMessages({
  ...
  empty: {
    id: "community_directory.moderation.empty",
    defaultMessage: "No entries pending review. All clear!",
  },
  ...
  deleteConfirm: {
    id: "community_directory.moderation.delete_confirm",
...
const CommunityDirectoryModeration = ({ multiColumn }) => {
  ...
  const loading = useAppSelector(
    (s) => s.get("community_directory")?.get("moderationLoading") || false,
  );
          ...
          {loading ? (
            ...
            <div className="cd-moderation__list">
              {queue.map((item) => {
                ...
                const submittedAt = new Date(item.get("submitted_at")).toLocaleDateString(
                  undefined,
                  {
                    year: "numeric",
                    month: "short",
                    ...
                    <div className="cd-moderation__item-body">
                      {account && (
                        <div className="cd-moderation__account">
                          ...
                          />
                          <span className="cd-moderation__username">
