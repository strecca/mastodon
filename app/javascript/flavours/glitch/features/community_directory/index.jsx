...
const messages = defineMessages({
  ...
  empty: {
    id: "community_directory.empty",
    defaultMessage: "No categories generated yet. Create your first one.",
  },
  entries: {
    id: "community_directory.entries",
  ...
  requiresApproval: {
    id: "community_directory.requires_approval",
    defaultMessage: "Require approval for new entries",
  },
  staleReject: {
    id: "community_directory.stale_reject",
    defaultMessage: "Auto-reject after (days)",
  },
...
const CategoryCard = ({ cat, setting, intl, dispatch }) => {
  ...
  const [maxEntries, setMaxEntries] = useState(
    setting?.get("max_entries_per_account")?.toString() || "",
  );
  const [periodDays, setPeriodDays] = useState(setting?.get("period_days")?.toString() || "");
  const [requiresApproval, setRequiresApproval] = useState(
    setting?.get("requires_approval") !== false,
  );
  const [staleRejectDays, setStaleRejectDays] = useState(
    setting?.get("stale_reject_after_days")?.toString() || "",
  );
  ...
  return (
    <div className="community-directory-admin__card">
      <div className="community-directory-admin__card-info">
        ...
        {description && <p className="community-directory-admin__card-desc">{description}</p>}
...
const CommunityDirectoryAdmin = ({ multiColumn }) => {
  ...
  const loading = useAppSelector(
    (s) => s.get("community_directory")?.get("categoriesLoading") || false,
  );
      ...
      <div className="scrollable">
        <div className="community-directory-admin">
          <div className="community-directory-admin__header">
            ...
            <Link to="/community_directory/locations" className="button button-secondary">
