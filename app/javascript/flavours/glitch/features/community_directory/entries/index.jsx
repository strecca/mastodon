...
const messages = defineMessages({
  ...
  deleteConfirm: {
    id: "community_directory.entries.delete_confirm",
    defaultMessage: 'Permanently delete "{name}"? This cannot be undone.',
  },
  empty: { id: "community_directory.entries.empty", defaultMessage: "No entries found." },
  total: {
    id: "community_directory.entries.total",
    defaultMessage: "{count} {count, plural, one {entry} other {entries}}",
  },
                ...
                {entries.map((entry) => (
                  <tr key={entry.id} className="cd-entries__row">
                    <td className="cd-entries__cell cd-entries__cell--name">
                      <Link
                        to={`/community_${entry.category_key}/${entry.id}`}
                        className="cd-entries__entry-link"
                      >
                        {entry.name}
                      </Link>
