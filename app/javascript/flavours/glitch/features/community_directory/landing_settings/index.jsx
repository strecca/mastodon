...
const FIELDS = [
  {
    ...
    label: "Site name",
    type: "input",
    hint: "Main heading on the landing page (e.g. Centro Comunitario)",
  },
  {
    key: "site_subtitle",
    label: "Subtitle",
    type: "input",
    hint: "Line below the site name (e.g. Mia Civezza al Mare)",
  },
  {
    key: "tagline",
    label: "Tagline",
    type: "textarea",
    hint: "Short description shown in the hero section",
  },
  {
    key: "join_heading",
    label: "Join heading",
    type: "input",
    hint: "Heading of the sign-up CTA section",
  },
  {
    key: "join_body",
    label: "Join body",
    type: "textarea",
    hint: "Paragraph text in the sign-up CTA section",
  },
];
      ...
      <div className="cl-landing-settings scrollable">
        {loading ? (
          ...
          <form className="cl-landing-settings__form" onSubmit={handleSubmit}>
            ...
            {saved && (
              <p className="cl-landing-settings__success">Saved! Changes are live immediately.</p>
            )}
