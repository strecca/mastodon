...
import { unfollowAccount, muteAccount, blockAccount } from "flavours/glitch/actions/accounts";
      ...
      <>
        <NavigationFocusTarget as="h1" className="report-dialog-modal__title">
          {submitted ? (
            ...
            <FormattedMessage id="report.thanks.title" defaultMessage="Don't want to see this?" />
          )}
