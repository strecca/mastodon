  ...
  pages = [
    ({ intl, onChange, settings }) => (
      <div className="glitch local-settings__page general">
        ...
        <section>
          <h2>
            <FormattedMessage id="settings.status_icons" defaultMessage="Toot icons" />
          </h2>
          <LocalSettingsPageItem
            settings={settings}
        ...
        <section>
          <h2>
            <FormattedMessage id="settings.layout_opts" defaultMessage="Layout options" />
          </h2>
          <LocalSettingsPageItem
            settings={settings}
            item={["stretch"]}
          ...
          >
            <FormattedMessage
              id="settings.fullwidth_view"
              defaultMessage="Stretch columns to full width (Desktop mode only)"
            />
            <span className="hint">
              <FormattedMessage
                id="settings.fullwidth_view_hint"
                defaultMessage="Stretches columns to fill all the available space."
              />
            </span>
          </LocalSettingsPageItem>
        </section>
    ...
    ({ intl, onChange, settings }) => (
      <div className="glitch local-settings__page compose_box_opts">
        <h1>
          <FormattedMessage id="settings.compose_box_opts" defaultMessage="Compose box" />
        </h1>
        <LocalSettingsPageItem
          settings={settings}
        ...
        >
          <FormattedMessage
            id="settings.show_published_toast"
            defaultMessage="Display toast when publishing/saving a post"
          />
        </LocalSettingsPageItem>
        <LocalSettingsPageItem
          settings={settings}
    ...
    ({ intl, onChange, settings }) => (
      <div className="glitch local-settings__page content_warnings">
        <h1>
          <FormattedMessage id="settings.content_warnings" defaultMessage="Content Warnings" />
        </h1>
        <LocalSettingsPageItem
          settings={settings}
