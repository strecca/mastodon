...
class LocalSettings extends PureComponent {
  ...
  navigateTo = (index) => this.setState({ currentIndex: +index });
  ...
  render() {
    ...
    return (
      <div className="glitch modal-root__modal local-settings">
        <LocalSettingsNavigation index={currentIndex} onClose={onClose} onNavigate={navigateTo} />
        <LocalSettingsPage index={currentIndex} onChange={onChange} settings={settings} />
      </div>
    );
  }
}
