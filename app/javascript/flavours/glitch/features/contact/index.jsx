...
const ContactPage = ({ identity, multiColumn }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg =
        ...
        sc("contact_error_fallback", "Something went wrong. Please try again.");
      setErrorMsg(msg);
      setStatus("error");
    }
  };
  ...
  return (
    <Column>
      <ColumnHeader label={headerLabel} multiColumn={multiColumn} showBackButton />
          ...
          <div className="contact-page__success">
            ...
            <p>
              {sc(
                ...
                "Your message has been received. We appreciate you taking the time to write to us and will get back to you as soon as possible.",
              )}
            </p>
          </div>
        ) : (
          <form className="contact-page__form" onSubmit={handleSubmit}>
            ...
            {signedIn ? (
              <div className="contact-page__member-badge">
                ...
                {displayName && displayName !== username && <span> ({displayName})</span>}
              </div>
            ) : (
              <>
                ...
                <div className="contact-page__field">
                  <label htmlFor="contact-email">
                    {sc("contact_email_label", "Your email address")}
                  </label>
                  <input
                    id="contact-email"
                    type="email"
            ...
            {status === "error" && <div className="contact-page__error">{errorMsg}</div>}
            ...
            >
              {status === "submitting"
                ? sc("contact_submit_sending", "Sending…")
                : sc("contact_submit_btn", "Send Message")}
            </button>
          </form>
        )}
      </div>
