...
const messages = defineMessages({
  ...
  cta: {
    id: "community.restaurants.cta",
    defaultMessage: "Log In or Join to add your own Community Restaurants",
  },
});
...
const CommunityRestaurants = ({ multiColumn }) => {
  ...
  return (
    <Column
      ...
      className="col-restaurants"
    >
      <ColumnHeader
        title={sc("col_restaurants_title", intl.formatMessage(messages.title))}
        icon="star"
        iconComponent={StarIcon}
        multiColumn={multiColumn}
        className="ch-restaurants"
      />
      {!signedIn && (
