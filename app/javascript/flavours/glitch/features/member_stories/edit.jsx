...
const FIELDS = [
  ...
  },
  {
    ...
    prompt:
      "How did you come to know Civezza or the Imperia area? What first brought you here, and what keeps drawing you back?",
  ...
  },
  {
    ...
    prompt:
      "Share a memory or experience — from Civezza or anywhere — that shaped who you are today.",
  ...
  },
  {
    ...
    prompt:
      "What brought you here, and what are you hoping to connect with or contribute to this community?",
    ...
    async (e) => {
      ...
      try {
        const compressed = await compressImage(file, {
          onLargeFile: (mb) => setStatusMsg(intl.formatMessage(messages.compressingLarge, { mb })),
        });
        setStatusMsg(null);
  ...
  return (
    <div className="ms-edit__photo-slot">
      ...
      <input
        ...
        onChange={handleFile}
      />
      {!uploading && statusMsg && <p className="ms-edit__photo-error">{statusMsg}</p>}
    </div>
  );
};
...
const MemberStoriesEdit = ({ multiColumn }) => {
    ...
    return (
      <Column className="col-stories">
        ...
        <div className="ms-page">
          <p>
            Please <a href="/auth/sign_in">sign in</a> to write your story.
          </p>
        </div>
      </Column>
    );
  ...
  return (
    <Column className="col-stories">
      ...
      />
      <Helmet>
        <title>My Story · miacivezza</title>
      </Helmet>
      ...
      <div className="ms-page ms-edit">
        ...
        <Link to="/member_stories" className="ms-story__back">
          ← All Stories
        </Link>

        <p className="ms-edit__intro">
          Share a bit about yourself with the Civezza community. Answer as many or as few prompts as
          you like — your story is yours to tell. When you&apos;re ready, tick{" "}
          <strong>Publish</strong> so others can read it.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {FIELDS.map(({ key, label, prompt, placeholder }) => (
            <div key={key} className="ms-edit__field">
              <label className="ms-edit__label" htmlFor={`ms-${key}`}>
                {label}
              </label>
          ...
          <div className="ms-edit__field">
            <label className="ms-edit__label">
              Photos <span className="ms-edit__label-hint">(up to 3)</span>
            </label>
            <p className="ms-edit__prompt">
              Add photos that are meaningful to you — places you love, you at work or play, or
              Civezza memories.
            </p>
          ...
          <div className="ms-edit__workflow">
            ...
            <ol className="ms-edit__workflow-steps">
              <li>
                Fill in as many sections as you like — you don&apos;t need to complete everything at
                once.
              </li>
              <li>
                Click <strong>Save Story</strong> at any time to preserve your work. Your story
                stays private until you publish it.
              </li>
              <li>
                When you&apos;re ready to share with other members: tick{" "}
                <strong>Publish my story</strong> below, then click <strong>Save Story</strong>{" "}
                again. That save is what makes it visible.
              </li>
            </ol>
          </div>
