...
const Lightbox = ({ images, index, onClose, onPrev, onNext }) => {
  ...
  return (
    <div className="ms-lightbox" onClick={onClose} role="dialog" aria-modal="true">
      <button className="ms-lightbox__close" onClick={onClose} aria-label="Close photo viewer">
        ✕
      </button>
      ...
      <div className="ms-lightbox__content" onClick={(e) => e.stopPropagation()}>
        ...
        {images.length > 1 && (
          <>
            ...
            <span className="ms-lightbox__counter">
...
const MemberStoriesShow = ({ multiColumn, params }) => {
    ...
    return (
      <Column className="col-stories">
        ...
        <div className="ms-page ms-page--not-found">
          ...
          <Link to="/member_stories" className="button">
            ← All Stories
          </Link>
        </div>
      </Column>
  ...
  return (
    <Column className="col-stories">
      ...
      />
      <Helmet>
        <title>{account?.display_name} · Member Story · miacivezza</title>
      </Helmet>
      ...
      <div className="ms-page ms-story">
        ...
        {!signedIn && (
          <a
            href="/auth/sign_in"
            className="community-join-cta"
            style={{ "--cta-color": "#2C3E7A" }}
          >
