...
const Compose: React.FC<{ multiColumn: boolean }> = ({ multiColumn }) => {
  ...
  const showNotificationsBadge = useAppSelector(
    (state) =>
      ...
      state.local_settings.getIn(["notifications", "tab_badge"], false) as boolean,
  );
  ...
  const elephant = [glitchedElephant1, glitchedElephant2, glitchedElephant3, elephantUIPlane][
    elefriend
  ];
          ...
          {!columns.some((column) => column.get("id") === "NOTIFICATIONS") && (
            ...
            >
              <span className="icon-badge-wrapper">
                ...
                {showNotificationsBadge && unreadNotifications && <div className="icon-badge" />}
              </span>
            </Link>
          )}
