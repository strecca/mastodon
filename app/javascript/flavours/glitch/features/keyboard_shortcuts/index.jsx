          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <FormattedMessage id="keyboard_shortcuts.reply" defaultMessage="to reply" />
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>
                  <FormattedMessage id="keyboard_shortcuts.boost" defaultMessage="to boost" />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <FormattedMessage id="keyboard_shortcuts.quote" defaultMessage="Quote post" />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <FormattedMessage id="keyboard_shortcuts.bookmark" defaultMessage="to bookmark" />
                </td>
              </tr>
              <tr>
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.enter"
                ...
                <td>
                  <FormattedMessage id="keyboard_shortcuts.enter" defaultMessage="to open status" />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.translate"
                    defaultMessage="to translate a post"
                  />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <kbd>k</kbd>,{" "}
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.alt"
                    defaultMessage="Alt"
                    tagName="kbd"
                  />
                  +
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.page_up"
              ...
              <tr>
                <td>
                  ...
                  +
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.page_down"
              ...
              <tr>
                ...
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.top"
                    defaultMessage="Move to top of list"
                  />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.load_more"
                    defaultMessage='Focus "Load more" button'
                  />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.backspace"
              ...
              <tr>
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.keys.esc"
                    defaultMessage="Esc"
                    tagName="kbd"
                  />
                </td>
              ...
              <tr>
                ...
                <td>
                  <FormattedMessage
                    id="keyboard_shortcuts.explore"
                    defaultMessage="to open trending timeline"
                  />
                </td>
              </tr>
              <tr>
