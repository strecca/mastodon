...
const CommunityListings = ({ multiColumn }) => {
  ...
  return (
    <Column className="col-listings">
      ...
      />
      <Helmet>
        <title>Community Listings · miacivezza</title>
      </Helmet>
      ...
      <div className="cl-page">
        <div className="cl-hero">
          ...
          <div className="cl-hero__subtitle">
            {sc("listings_hero_subtitle", "Giveaway · Trade · Sell · Rent · In Search Of")}
          </div>
        </div>
        ...
        <div className="cl-toolbar">
          ...
          <form className="cl-search" onSubmit={handleSearch}>
            ...
            />
            <button type="submit" className="cl-search__btn">
              {sc("listings_search_btn", "Search")}
            </button>
            {search && (
              <button
                type="button"
                className="cl-search__clear"
                onClick={() => {
                  setSearch("");
                  setSearchInput("");
                }}
