...
const PreferencesTab = () => {
  ...
  const handleEmailFreq = useCallback(
    async (value) => {
      setSaving(true);
      setSaved(false);
      try {
  ...
  return (
    <div className="cv-notif-prefs">
      ...
      <section className="cv-notif-prefs__section">
        ...
        <p className="cv-notif-prefs__section-desc">
          How often should we email you about visit activity?
        </p>
      ...
      <section className="cv-notif-prefs__section">
        ...
        {[
          {
            field: "on_visit_overlap",
            label: "Visit overlaps",
            desc: KIND_DESCRIPTIONS.overlap_detected,
          },
          {
            field: "on_friend_ping",
            label: "Connection pings",
            desc: KIND_DESCRIPTIONS.friend_ping,
          },
          {
            field: "on_new_member",
            label: "New members joining",
            desc: "Get a notification when someone new joins the community",
          },
      ...
      {saved && <div className="cv-notif-prefs__saved-banner">Preferences saved</div>}
    </div>
  );
};
    ...
    <div className="cv-notif-inbox">
      ...
      {notifications.size === 0 ? (
        <div className="cv-notif-inbox__empty">
          No notifications yet. When connections have overlapping visits or ping you, they'll appear
          here.
        </div>
      ) : (
                ...
                <div className="cv-notif-inbox__body">
                  ...
                  {visit && (
                    <div className="cv-notif-inbox__visit-dates">
                      {new Date(visit.get("arrival_date") + "T00:00:00").toLocaleDateString(
                        undefined,
                        { month: "short", day: "numeric" },
                      )}
                      {" – "}
                      {new Date(visit.get("departure_date") + "T00:00:00").toLocaleDateString(
                        undefined,
      ...
      {pages > 1 && (
        <div className="cv-notif-inbox__pagination">
          ...
          <span className="cv-notif-inbox__page-info">
            Page {page} of {pages}
          </span>
          <button
            className="cv-nav-btn"
    ...
    <Column bindToDocument={!multiColumn} label="Visit Notifications">
      ...
      <div className="cv-page">
        ...
        <div className="cv-notif-footer">
          <Link to="/community_visits" className="cv-notif-footer__link">
            ← Back to calendar
          </Link>
        </div>
      </div>
