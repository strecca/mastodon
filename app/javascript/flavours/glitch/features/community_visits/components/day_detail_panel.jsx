...
export const DayDetailPanel = ({ date, visits, onClose, onEdit }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={`Visitors on ${fmtDate(date)}`}
    >
        ...
        <ul className="cv-day-panel__list">
          {visits.map((visit) => {
            ...
            return (
              <li
                key={visit.get("id")}
                className={`cv-day-panel__visitor${isPast ? " cv-day-panel__visitor--past" : ""}`}
              >
                ...
                <div className="cv-day-panel__visitor-info">
                  ...
                  {avail.length > 0 && (
                    <div className="cv-day-panel__chips">
                      {avail.map((k) => (
                        <span key={k} className="cv-day-panel__chip">
                  ...
                  {isOwn && vis && (
                    <span className="cv-day-panel__visibility">
