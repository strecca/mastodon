    ...
    <div className="cv-my-people">
      <div className="cv-my-people__header">
        <h3 className="cv-my-people__title">
          ...
          My People
          {myPeople.size > 0 && <span className="cv-my-people__count">{myPeople.size}</span>}
        </h3>
        <button
          type="button"
      ...
      <p className="cv-my-people__desc">
        A private group you curate. Add followers here, then choose "My People" visibility when
        posting a visit — only they'll see it.
      </p>
