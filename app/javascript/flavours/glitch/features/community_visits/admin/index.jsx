  ...
  return (
    <span className="cv-admin__avail-chips">
      {availabilities.map((a) => (
        <span key={a} className="cv-admin__avail-chip">
          {a}
        </span>
      ))}
    </span>
...
export default function CommunityVisitsAdmin({ multiColumn }) {
  ...
  return (
    <Column>
      ...
      <Helmet>
        <title>Visits Admin · miacivezza</title>
      </Helmet>
      ...
      <div className="cv-admin">
        ...
        <form className="cv-admin__filters" onSubmit={handleApplyFilters}>
          ...
          <input
            ...
            placeholder="To"
          />
          <button type="submit" className="cv-admin__filter-apply">
            Apply
          </button>
          <button
            type="button"
          ...
          <>
            ...
            <div className="cv-admin__list">
              {visits.length === 0 ? (
                ...
                visits.map((v) => <VisitRow key={v.id} visit={v} onDelete={handleDelete} />)
              )}
            </div>
          </>
        )}
