...
const messages = defineMessages({
  ...
  cta: {
    id: "community.artists.cta",
    defaultMessage: "Log In or Join to add your own Community Artists",
  },
});
...
const CommunityArtists = ({ multiColumn }) => {
  ...
  return (
    ...
    >
      <ColumnHeader
        title={sc("col_artists_title", intl.formatMessage(messages.title))}
        icon="brush"
        iconComponent={BrushIcon}
        multiColumn={multiColumn}
        className="ch-artists"
      />
      {!signedIn && (
