    ...
    <div className="cl-landing scrollable">
      ...
      <header className="cl-landing__hero">
        <div className="cl-landing__logo">
          <span className="cl-landing__logo-main">
            {sc("landing_logo_text", "Civezza Community Directory")}
          </span>
        </div>
        <p className="cl-landing__tagline">
        ...
        <div className="cl-landing__hero-actions">
          ...
          <Link
            to="/directory"
            className="cl-landing__see-posts-btn cl-landing__see-posts-btn--secondary"
          >
            {sc("landing_browse_profiles_btn", "Browse Profiles")}
          </Link>
          {!signedIn && (
            <a href="/auth/sign_in" className="cl-landing__login-link">
      ...
      <section className="cl-landing__section">
        <div className="cl-landing__tiles">
          {TILE_DEFS.map(({ to, Icon, key, bg }) => (
            <Link key={to} to={to} className="cl-landing__tile" style={{ "--tile-bg": bg }}>
      ...
      {!signedIn && (
        <section className="cl-landing__cta">
          <h2 className="cl-landing__cta-title">
            {sc("landing_join_heading", "Join the MiaCivezza.com Community")}
          </h2>
          <ul className="cl-landing__cta-features">
            <li className="cl-landing__cta-feature">
              <span className="cl-landing__cta-feature-icon">
                <CelebrationIcon />
              </span>
              <span>
                {sc(
                  "landing_join_feature_1",
                  "Make your own posts, add Civezza Community Events, Favorite Restaurants, and list items for Sale, Giveaway, Trade or Searching For — plus Properties for Sale, Rent or short-term Vacation stays.",
                )}
              </span>
            </li>
            <li className="cl-landing__cta-feature">
              ...
              <span>
                {sc(
                  ...
                  "In the Community Services section, share your skills or recommend Builders, Architects, Craftspeople, Cooks, Cleaning services, Property Management, and guidance on permits, regulations, and local contacts.",
                )}
              </span>
            </li>
            <li className="cl-landing__cta-feature">
              ...
              <span>
                {sc(
                  ...
                  "Post When I'll Be In Town to privately share the dates you'll be returning to Civezza or the Imperia area — and let Members know you'd love to connect while you're back in Italy.",
                )}
              </span>
            </li>
          </ul>
          <p className="cl-landing__cta-footer">
            {sc(
              "landing_join_footer",
              "Registration is Free. No Credit Card required. Come Join us!",
            )}
          </p>
          <div className="cl-landing__cta-actions">
            <a href="/auth/sign_up" className="button cl-landing__signup-btn">
