...
const QuickShareNew = ({ identity, multiColumn }) => {
  ...
  return (
    <Column>
      ...
      <Helmet>
        <title>Quick Share a PDF · miacivezza</title>
      </Helmet>
        ...
        {!canCreate ? (
          ...
          <form className="qs-form" onSubmit={handleSubmit}>
            <p className="qs-form__intro">
              Upload a PDF and write a short caption. You&apos;ll get a page you can share right
              away — and, if you want, post about it yourself afterwards.
            </p>

            <label className="qs-form__label" htmlFor="qs-caption">
              Caption
            </label>
            <textarea
              id="qs-caption"
            ...
            <label className="qs-form__label" htmlFor="qs-pdf">
              PDF file
            </label>
            <input
              id="qs-pdf"
