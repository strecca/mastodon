...
const messages = defineMessages({
  ...
  cta: {
    id: "community.properties.cta",
    defaultMessage: "Log In or Join to add your own Community Properties",
  },
});
...
const CommunityProperties = ({ multiColumn }) => {
  ...
  return (
    ...
    >
      <ColumnHeader
        title={sc("col_properties_title", intl.formatMessage(messages.title))}
        icon="home"
        iconComponent={HomeIcon}
        multiColumn={multiColumn}
        className="ch-properties"
      />
      {!signedIn && (
