...
export const Conversation = ({ conversation, scrollKey }) => {
  ...
  const sharedCWState = useSelector((state) =>
    state.getIn(["state", "content_warnings", "shared_state"]),
  );
  ...
  const menu = [
    ...
    null,
    {
      text: intl.formatMessage(
        lastStatus.get("muted") ? messages.unmuteConversation : messages.muteConversation,
      ),
