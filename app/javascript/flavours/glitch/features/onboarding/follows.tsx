...
export const Follows: React.FC<{
  ...
  if (mode === "add" && isSearching) {
    ...
    displayedAccountIds = suggestions.map((suggestion) => suggestion.account_id);
  }
  ...
  return (
    <Column bindToDocument={!multiColumn} label={intl.formatMessage(messages.title)}>
      ...
      <ScrollableList
        ...
        showLoading={(isLoading || isLoadingSearch) && displayedAccountIds.length === 0}
        hasMore={false}
        ...
        emptyMessage={
          mode === "remove" ? (
            ...
            <FormattedMessage id="lists.no_results_found" defaultMessage="No results found." />
          )
        }
      >
