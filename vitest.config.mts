...
import { configDefaults, defineConfig, TestProjectInlineConfiguration } from "vitest/config";
...
const legacyTests: TestProjectInlineConfiguration = {
  ...
  test: {
    name: "legacy-tests",
    environment: "jsdom",
    include: [...configDefaults.include, "**/__tests__/**/*.{js,mjs,cjs,ts,mts,cts,jsx,tsx}"],
    exclude: [
