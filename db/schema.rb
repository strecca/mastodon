...
ActiveRecord::Schema[8.1].define(version: 2026_08_06_094703) do
  ...
  create_table "community_artists", force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "community_directory_category_settings", force: :cascade do |t|
    ...
    t.integer "stale_reject_after_days"
    t.datetime "updated_at", null: false
    t.index ["category_key"], name: "index_community_directory_category_settings_on_category_key", unique: true
  end

  create_table "community_directory_permissions", force: :cascade do |t|
    t.bigint "account_id", null: false
